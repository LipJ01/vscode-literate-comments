...
export function activate(context: ExtensionContext) {
	...
	context.subscriptions.push(
		...
		commands.registerCommand("literate-comments.preview", previewCommand(context, false)),
		commands.registerCommand("literate-comments.previewToSide", previewCommand(context, true)),
		commands.registerCommand("literate-comments.codeLensPreview", codeLensPreviewCommand(context))
	);
}
